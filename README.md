...
```bash
git clone https://github.com/f01zy/Online-Console-Chess/ && cd Online-Console-Chess
...
### Server
If you are going to run a local server, you need to clone the [server](https://github.com/f01zy/Online-Console-Chess/tree/server) source code for yourself, fill in the environment variable (rename .example.env to .development.env), and run the server.

```bash
git clone https://github.com/f01zy/Online-Console-Chess/ -b server && cd Online-Console-Chess
bun i
